...
double round_up_nearest_cent(double bill) {
  double multiplied = ceil(bill * 100);
...
void c_math_functions() {
    ...
    double multiplied = ceil(individual_bill * 100);
    double individual_bill_3 {multiplied / 100};
